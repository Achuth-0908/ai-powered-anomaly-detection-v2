...
<details>
<summary><b>☁️ Option 3: Streamlit Cloud Deployment</b></summary>
...
| :----: | :----------------------- | :--------------------------------------------- |
| **1️⃣** | **Upload Dataset**       | Use the file uploader to select your CSV file  |
| **2️⃣** | **Configure Parameters** | Adjust model parameters in the sidebar         |
| **3️⃣** | **Run Analysis**         | Click "Start Anomaly Detection" to process     |
| **4️⃣** | **View Results**         | Explore interactive visualizations and metrics |
| **5️⃣** | **Download Results**     | Export CSV results or summary reports          |
